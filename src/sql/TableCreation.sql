...
CREATE TABLE TAGS (
    ...
    NEWS_MAG_ID BIGINT NOT NULL,
    TAG_MAG_ID INT NOT NULL,
    UNIQUE UNIQUE_NEWS_TAGS_MAG (NEWS_TAG_MAG_ID, NEWS_TAGS_MAG, TAG_MAG_ID),
    ...
    CONSTRAINT FK_TAGMAG_NEWS_1 FOREIGN KEY (NEWS_MAG_ID) REFERENCES NEWS (NEWS_ID) ON DELETE CASCADE ON UPDATE CASCADE
);